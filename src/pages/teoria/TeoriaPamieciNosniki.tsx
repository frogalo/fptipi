...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_2} alt="Charakterystyka potencjału w złączu p-n-p"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.2. Charakterystyka potencjału w złączu p–n–p a) bez polaryzacji, b) po przyłożeniu napięcia U<sub>CE</sub>, c) złącze emiter–baza spolaryzowane w kierunku przewodzenia napięciem U<sub>BE</sub>.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_4} alt="Przekrój MOSFET - polaryzacja zerowa"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.4. Przekrój tranzystora MOSFET, gdy polaryzacja bramki i drenu jest zerowa.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_5} alt="Przekrój MOSFET - polaryzacja bramki dodatnia"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.5. Przekrój tranzystora MOSFET, gdy polaryzacja bramki jest dodatnia a drenu zerowa.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_6} alt="Przekrój MOSFET - polaryzacja bramki i drenu dodatnia"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.6. Przekrój tranzystora MOSFET, gdy polaryzacja bramki i drenu jest dodatnia.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_8} alt="Charakterystyka wyjściowa MOSFET" style={{ "maxWidth": "380px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.8. Charakterystyka wyjściowa tranzystora MOSFET.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_9} alt="Przekrój płyty CD-R"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.2. Przekrój poprzeczny przez płytę CD–R.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_10} alt="Przekrój płyty CD-RW"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.4. Przekrój poprzeczny przez płytę CD–RW.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_12} alt="Pity i landy" style={{ "maxWidth": "360px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.6. Pity i landy na dysku optycznym.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_14} alt="Zapis cyfrowy na płycie" style={{ "maxWidth": "480px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.8. Zapis cyfrowy na płycie.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_15} alt="Rozkład pitów CD vs DVD"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.13. Rozkład pitów na płytach CD i DVD.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_16} alt="Zapis i kasowanie na płytach magneto-optycznych"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.12. Sposób a) zapisu, b) kasowania danych na płytach magneto–optycznych.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_17} alt="Układ do odczytu i zapisu na płytach MO"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.10. Układ a) do odczytu oraz b) do zapisu na płytach magneto–optycznych.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_18} alt="Pętla histerezy magnetycznej" style={{ "maxWidth": "380px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.1. Pętla histerezy magnetycznej dla materiałów magnetycznie miękkich (linia zielona) i twardych (linia czerwona).</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_19} alt="Cyfrowy zapis na taśmie magnetycznej" style={{ "maxWidth": "440px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.3. Schemat cyfrowego zapisu na taśmach magnetycznych.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaPamieciNosniki_img_21} alt="Organizacja pamięci na krążku" style={{ "maxWidth": "380px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.5. Organizacja pamięci na krążku magnetycznym.</figcaption></figure>
