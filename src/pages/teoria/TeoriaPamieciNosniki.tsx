import bjt_symbole_schematy_diodowe_npn_pnp from '../../assets/bjt_symbole_schematy_diodowe_npn_pnp.jpeg';
import bjt_rozklad_potencjalu_wanna_pnp_polaryzacje from '../../assets/bjt_rozklad_potencjalu_wanna_pnp_polaryzacje.jpeg';
import bjt_charakterystyka_pradowo_napieciowa_ic_uce from '../../assets/bjt_charakterystyka_pradowo_napieciowa_ic_uce.jpeg';
import mosfet_przekroj_polaryzacja_zerowa from '../../assets/mosfet_przekroj_polaryzacja_zerowa.jpeg';
import mosfet_przekroj_bramka_dodatnia_dren_zerowy from '../../assets/mosfet_przekroj_bramka_dodatnia_dren_zerowy.jpeg';
import mosfet_przekroj_bramka_i_dren_dodatnie from '../../assets/mosfet_przekroj_bramka_i_dren_dodatnie.jpeg';
import mosfet_przekroj_zwezenie_kanalu_uds_rowne_ugs from '../../assets/mosfet_przekroj_zwezenie_kanalu_uds_rowne_ugs.jpeg';
import mosfet_charakterystyka_wyjsciowa_id_uds from '../../assets/mosfet_charakterystyka_wyjsciowa_id_uds.jpeg';
import nosniki_plyta_cd_r_przekroj_poprzeczny from '../../assets/nosniki_plyta_cd_r_przekroj_poprzeczny.jpeg';
import nosniki_plyta_cd_rw_przekroj_poprzeczny from '../../assets/nosniki_plyta_cd_rw_przekroj_poprzeczny.jpeg';
import nosniki_struktura_amorficzna_i_krystaliczna_faza from '../../assets/nosniki_struktura_amorficzna_i_krystaliczna_faza.jpeg';
import nosniki_pity_i_landy_dysk_optyczny from '../../assets/nosniki_pity_i_landy_dysk_optyczny.jpeg';
import nosniki_uklad_glowica_odczyt_zapis_cd from '../../assets/nosniki_uklad_glowica_odczyt_zapis_cd.jpeg';
import nosniki_zapis_cyfrowy_sygnal_rf_plyta from '../../assets/nosniki_zapis_cyfrowy_sygnal_rf_plyta.jpeg';
import nosniki_porownanie_pitow_cd_vs_dvd from '../../assets/nosniki_porownanie_pitow_cd_vs_dvd.jpeg';
import nosniki_zapis_i_kasowanie_plyty_magneto_optyczne_mo from '../../assets/nosniki_zapis_i_kasowanie_plyty_magneto_optyczne_mo.jpeg';
import nosniki_uklad_odczyt_zapis_plyty_magneto_optyczne_mo from '../../assets/nosniki_uklad_odczyt_zapis_plyty_magneto_optyczne_mo.jpeg';
import magnetyczne_petla_histerezy_miekki_twardy from '../../assets/magnetyczne_petla_histerezy_miekki_twardy.jpeg';
import magnetyczne_zapis_cyfrowy_tasma_magnetyczna from '../../assets/magnetyczne_zapis_cyfrowy_tasma_magnetyczna.jpeg';
import magnetyczne_dysk_twardy_hdd_wnetrze_budowa from '../../assets/magnetyczne_dysk_twardy_hdd_wnetrze_budowa.jpeg';
import magnetyczne_organizacja_pamieci_sciezki_sektory_hdd from '../../assets/magnetyczne_organizacja_pamieci_sciezki_sektory_hdd.jpeg';
import magnetyczne_glowica_odczytujaca_gmr_schemat from '../../assets/magnetyczne_glowica_odczytujaca_gmr_schemat.jpeg';
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={bjt_symbole_schematy_diodowe_npn_pnp} alt="Symbole tranzystorów bipolarnych"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.1. Symbole graficzne i diodowe schematy zastępcze a) tranzystor n–p–n i b) p–n–p.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={bjt_rozklad_potencjalu_wanna_pnp_polaryzacje} alt="Charakterystyka potencjału w złączu p-n-p"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.2. Charakterystyka potencjału w złączu p–n–p a) bez polaryzacji, b) po przyłożeniu napięcia U<sub>CE</sub>, c) złącze emiter–baza spolaryzowane w kierunku przewodzenia napięciem U<sub>BE</sub>.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={bjt_charakterystyka_pradowo_napieciowa_ic_uce} alt="Charakterystyka prądowo-napięciowa tranzystora"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.3. Charakterystyka prądowo–napięciowa tranzystora.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={mosfet_przekroj_polaryzacja_zerowa} alt="Przekrój MOSFET - polaryzacja zerowa"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.4. Przekrój tranzystora MOSFET, gdy polaryzacja bramki i drenu jest zerowa.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={mosfet_przekroj_bramka_dodatnia_dren_zerowy} alt="Przekrój MOSFET - polaryzacja bramki dodatnia"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.5. Przekrój tranzystora MOSFET, gdy polaryzacja bramki jest dodatnia a drenu zerowa.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={mosfet_przekroj_bramka_i_dren_dodatnie} alt="Przekrój MOSFET - polaryzacja bramki i drenu dodatnia"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.6. Przekrój tranzystora MOSFET, gdy polaryzacja bramki i drenu jest dodatnia.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={mosfet_przekroj_zwezenie_kanalu_uds_rowne_ugs} alt="Przekrój MOSFET przy UDS=UGS"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.7. Przekrój tranzystora MOSFET gdy polaryzacja bramki i drenu jest dodatnia U<sub>DS</sub> = U<sub>GS</sub>.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={mosfet_charakterystyka_wyjsciowa_id_uds} alt="Charakterystyka wyjściowa MOSFET" style={{ "maxWidth": "380px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 7.8. Charakterystyka wyjściowa tranzystora MOSFET.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_plyta_cd_r_przekroj_poprzeczny} alt="Przekrój płyty CD-R"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.2. Przekrój poprzeczny przez płytę CD–R.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_plyta_cd_rw_przekroj_poprzeczny} alt="Przekrój płyty CD-RW"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.4. Przekrój poprzeczny przez płytę CD–RW.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_struktura_amorficzna_i_krystaliczna_faza} alt="Struktura amorficzna i krystaliczna" style={{ "maxWidth": "420px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.5. Struktura amorficzna i krystaliczna.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_pity_i_landy_dysk_optyczny} alt="Pity i landy" style={{ "maxWidth": "360px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.6. Pity i landy na dysku optycznym.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_uklad_glowica_odczyt_zapis_cd} alt="Układ do odczytu i zapisu na płytach CD" style={{ "maxWidth": "430px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.7. Układ do odczytu lub do zapisu na płytach CD.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_zapis_cyfrowy_sygnal_rf_plyta} alt="Zapis cyfrowy na płycie" style={{ "maxWidth": "480px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.8. Zapis cyfrowy na płycie.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_porownanie_pitow_cd_vs_dvd} alt="Rozkład pitów CD vs DVD"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.13. Rozkład pitów na płytach CD i DVD.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_zapis_i_kasowanie_plyty_magneto_optyczne_mo} alt="Zapis i kasowanie na płytach magneto-optycznych"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.12. Sposób a) zapisu, b) kasowania danych na płytach magneto–optycznych.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={nosniki_uklad_odczyt_zapis_plyty_magneto_optyczne_mo} alt="Układ do odczytu i zapisu na płytach MO"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 8.10. Układ a) do odczytu oraz b) do zapisu na płytach magneto–optycznych.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={magnetyczne_petla_histerezy_miekki_twardy} alt="Pętla histerezy magnetycznej" style={{ "maxWidth": "380px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.1. Pętla histerezy magnetycznej dla materiałów magnetycznie miękkich (linia zielona) i twardych (linia czerwona).</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={magnetyczne_zapis_cyfrowy_tasma_magnetyczna} alt="Cyfrowy zapis na taśmie magnetycznej" style={{ "maxWidth": "440px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.3. Schemat cyfrowego zapisu na taśmach magnetycznych.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={magnetyczne_dysk_twardy_hdd_wnetrze_budowa} alt="Twardy dysk po zdjęciu obudowy" style={{ "maxWidth": "480px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.4. Twardy dysk po zdjęciu obudowy.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={magnetyczne_organizacja_pamieci_sciezki_sektory_hdd} alt="Organizacja pamięci na krążku" style={{ "maxWidth": "380px" }}/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.5. Organizacja pamięci na krążku magnetycznym.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={magnetyczne_glowica_odczytujaca_gmr_schemat} alt="Schemat działania głowicy odczytującej GMR"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 ">Rysunek 9.6. Schemat działania głowicy odczytującej.</figcaption></figure>
