...
<tbody><tr><th className="border border-line px-2.5 py-1.5 font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">Okres \ Grupa</th><th className="border border-line px-2.5 py-1.5 text-center font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">III</th><th className="border border-line px-2.5 py-1.5 text-center font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">IV</th><th className="border border-line px-2.5 py-1.5 text-center font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">V</th><th className="border border-line px-2.5 py-1.5 text-center font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">VI</th><th className="border border-line px-2.5 py-1.5 text-center font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">VII</th></tr>
<tr><td className="border border-line px-2.5 py-1.5 ">II</td><td className="border border-line px-2.5 py-1.5 text-center">B (1,1 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">C (5,2 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">—</td><td className="border border-line px-2.5 py-1.5 text-center">—</td><td className="border border-line px-2.5 py-1.5 text-center">—</td></tr>
<tr><td className="border border-line px-2.5 py-1.5 ">III</td><td className="border border-line px-2.5 py-1.5 text-center">—</td><td className="border border-line px-2.5 py-1.5 text-center">Si (1,1 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">P (1,5 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">S (2,5 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">—</td></tr>
<tr><td className="border border-line px-2.5 py-1.5 ">IV</td><td className="border border-line px-2.5 py-1.5 text-center">—</td><td className="border border-line px-2.5 py-1.5 text-center">Ge (0,7 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">As (1,2 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">Se (1,7 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">—</td></tr>
<tr><td className="border border-line px-2.5 py-1.5 ">V</td><td className="border border-line px-2.5 py-1.5 text-center">—</td><td className="border border-line px-2.5 py-1.5 text-center">Sn (0,08 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">Sb (0,12 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">Te (0,36 eV)</td><td className="border border-line px-2.5 py-1.5 text-center">J (1,25 eV)</td></tr>
</tbody></table>
...
<table className="w-full border-collapse my-3 text-[14.5px]">
<tbody><tr><th className="border border-line px-2.5 py-1.5 text-left font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider"></th><th className="border border-line px-2.5 py-1.5 text-left font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">Kierunek zaporowy</th><th className="border border-line px-2.5 py-1.5 text-left font-mono text-[11.5px] text-amber-soft bg-ink2 tracking-wider">Kierunek przewodzenia</th></tr>
