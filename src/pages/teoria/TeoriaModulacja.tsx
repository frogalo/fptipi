...
<p className="mb-[11px] text-[14px] text-muted -mt-1 mb-[14px]">gdzie: <code className="font-mono text-txt text-[12.5px]">p<sub>0</sub></code> — prawdopodobieństwo potraktowania „1" jako „0"; <code className="font-mono text-txt text-[12.5px]">p<sub>1</sub></code> — prawdopodobieństwo potraktowania „0" jako „1".</p>
...
<div className="rounded-[10px] px-4 py-[14px] my-[14px] border border-line bg-red/10 border-[#7d3a3a]"><span className="font-mono text-[11px] tracking-[0.14em] uppercase block mb-2">Drobna nieścisłość w podręczniku</span>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaModulacja_img_1} alt="Wykres oczkowy"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 text-left">Rysunek 5.4. Wykres oczkowy.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaModulacja_img_2} alt="Przykładowe wykresy oczkowe"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 text-left">Rysunek 5.5. Przykładowe wykresy oczkowe dla łącz telekomunikacyjnych.</figcaption></figure>
...
<p className="mb-[11px] text-[14px] text-muted -mt-1 mb-[14px]">gdzie: <code className="font-mono text-txt text-[12.5px]">R<sub>b</sub></code> — szybkość transmisji; <code className="font-mono text-txt text-[12.5px]">B</code> — szerokość pasma częstotliwości zajmowanego przez sygnał zmodulowany.</p>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaModulacja_img_3} alt="Modulacja analogowa"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 text-left">Rysunek 5.1. Modulacja sygnału analogowego: a) fala nośna, b) sygnał analogowy, c) sygnał zmodulowany.</figcaption></figure>
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaModulacja_img_4} alt="Modulacja cyfrowa"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 text-left">Rysunek 5.2. Modulacja sygnału cyfrowego: a) fala nośna, b) sygnał cyfrowy, c) sygnał zmodulowany.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaModulacja_img_5} alt="Klasyfikacja technik multipleksacji"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 text-left">Rysunek 5.6. Klasyfikacja technik multipleksacji w zależności od odstępu między nośnymi.</figcaption></figure>
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]"><img src={TeoriaModulacja_img_6} alt="Podział trzeciego okna"/><figcaption className="font-mono text-[11px] text-[#555] mt-2 text-left">Rysunek 5.7. Podział trzeciego okna na częstotliwości nośne.</figcaption></figure>
...
<p className="mb-[11px] text-[14px] text-muted -mt-1 mb-[14px]">gdzie <code className="font-mono text-txt text-[12.5px]">P<sub>m</sub></code> — moc optyczna m-tego kanału.</p>
...
<p className="mb-[11px] text-[14px] text-muted -mt-1 mb-[14px]">gdzie {String.raw`\(i,j\neq k\)`}.</p>
...
<p className="mb-[11px] text-[14px] text-muted -mt-1 mb-[14px]">gdzie <code className="font-mono text-txt text-[12.5px]">N</code> — liczba fal podstawowych.</p>
