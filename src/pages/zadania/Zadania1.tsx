...
import propagacja_tlumienie_mikrofal_atmosfera_wykres from '../../assets/propagacja_tlumienie_mikrofal_atmosfera_wykres.png';
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]">
  <img src={propagacja_tlumienie_mikrofal_atmosfera_wykres} alt="Wykres tłumienia atmosferycznego w funkcji częstotliwości"/>
...
<Footer>FPTiTI · Zadania obliczeniowe cz. 1 · powtórka przed egzaminem · powodzenia! 💪</Footer>
</div>
