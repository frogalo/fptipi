...
import modulacja_wykres_oczkowy_parametry_zestawienie from '../../assets/modulacja_wykres_oczkowy_parametry_zestawienie.png';
...
<figure className="my-4 mx-auto text-center bg-white rounded-[10px] p-[14px] border border-line max-w-[680px]">
  <img src={modulacja_wykres_oczkowy_parametry_zestawienie} alt="Wykres oczkowy z zaznaczonymi parametrami"/>
